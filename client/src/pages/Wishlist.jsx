    ...
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {items.map((item) => (
          <div
            key={item.id}
            className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 overflow-hidden hover:shadow-md transition-all"
          >
            ...
            <div className="p-4">
              ...
              <Link to={`/products/${item.slug}`}>
                <h3 className="text-sm font-medium text-gray-900 dark:text-white mb-2 line-clamp-1 hover:underline">
                  {item.name}
                </h3>
              </Link>
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-1.5 bg-gray-900 dark:bg-white text-white dark:text-gray-900 py-2 rounded-lg text-xs font-medium hover:bg-gray-700 dark:hover:bg-gray-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
