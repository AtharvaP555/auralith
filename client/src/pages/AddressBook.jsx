    ...
    <div className="max-w-2xl mx-auto">
            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  {address.isDefault && (
                    <span className="flex items-center gap-1 text-xs font-medium bg-gray-900 text-white px-2 py-0.5 rounded-full">
                ...
                <div className="flex items-center gap-1">
                  {!address.isDefault && (
                    <button
                      ...
                      className="p-1.5 text-xs text-gray-400 hover:text-gray-900 transition-colors"
      ...
      {showForm && (
        <div className="fixed inset-0 bg-black/30 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-md max-h-screen overflow-y-auto p-6">
